...
<p>Backend REST API for Invoice Generation & Document Archiving</p>
...
│   └── clients/        # Client record management
...
```bash
git clone https://github.com/MohammadKevin/invdocs-api.git
cd invdocs-api
npm install
npm run start:dev
```
